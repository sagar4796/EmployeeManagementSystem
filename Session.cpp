...
#define STUB(functionName)  std::any functionName( SessionBase & /*session*/, const std::vector<std::string> & /*args*/ ) \
...
std::any checkoutBook(SessionBase& session, const std::vector<std::string>& args)
{
